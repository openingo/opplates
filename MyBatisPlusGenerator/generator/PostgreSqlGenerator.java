...
public class PostgreSqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:postgresql://192.168.1.38:5432/zcq");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + projectName +"/src/main/resources/mapper.postgres/" + tableInfo.getMapperName() + StringPool.DOT_XML;
            }
        });
