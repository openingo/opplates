...
public class OrclGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:oracle:thin:@192.168.1.38:1521:ORCL");
        // dsc.setSchemaName("public");
        dsc.setDriverName("oracle.jdbc.OracleDriver");
        dsc.setUsername("ORCL");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + projectName +"/src/main/resources/mapper.orcl/" + tableInfo.getMapperName() + StringPool.DOT_XML;
            }
        });
